...
def main():
    ...
    for frame_idx in range(total_frames):
        ...
        cv2.putText(left_panel, "Championship Controller v4", (50, 80),
    ...
    subprocess.run(['ffmpeg', '-y', '-i', out_path, '-c:v', 'libx264', '-preset', 'fast', '-crf', '23',
                    ...
                    '/tmp/robot_sim_v4_final.mp4'], capture_output=True)
    
    # 复制
    subprocess.run(['cp', '/tmp/robot_sim_v4_final.mp4',
